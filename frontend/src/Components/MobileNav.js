//This MobileNav component has a sidebar navigation that appears on mobile devices.
// The component contains a list of links, including links to the user's profile, explore, bookmarks, news, and a logout button.
// It also displays the user's profile photo, name, and number of followers/following.
// The component  handle the routing and  dispatch an action to log out the user when the user clicks the logout button.
// It uses userInfo as prop, and dispatch to dispatch the USER_LOGOUT action when the user clicks the logout button.
