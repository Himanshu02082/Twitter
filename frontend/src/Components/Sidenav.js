// The Sidenav component displays a navigation menu . 
// We have imported  constant called USER_LOGOUT.The component takes a single prop named "userInfo".
// There are links created using the Link component to link to a different page.
// There are buttons made such that One button is visible on larger screens and the other is visible on smaller screens.
// Clicking either button opens a modal for composing a tweet.
// Finally, there is a "Logout" link at the bottom of the sidenav.
// When clicked, the "Logout" link removes the "userId" item from the local storage and
// dispatches a USER_LOGOUT action to the Redux store.
